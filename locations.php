...
function deleteLocation() {
    ...
    try {
        $pdo = getPDO();
        // Sections/rooms under this location cascade via their own FKs;
        // any guests in those sections/rooms would be orphaned by that
        // cascade too (guests.guest_section/guest_room have ON DELETE
        // CASCADE back to section_names/room_names), so make sure that's
        // really what you want before deleting a location with guests in it.
